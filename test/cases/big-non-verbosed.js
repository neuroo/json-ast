...
var ast = array([
  object([
    ...
    prop(key('isActive'), _true()), prop(key('balance'), string('$1,087.03')),
    prop(key('picture'), string('http://placehold.it/32x32')),
    prop(key('age'), number('25')), prop(key('eyeColor'), string('brown')),
    ...
    prop(key('address'),
         string('547 Charles Place, Weogufka, Marshall Islands, 6627')),
    prop(
        key('about'),
        string(
    ...
    prop(key('tags'), array([
           string('veniam'), string('et'), string('cillum'), string('ex'),
           string('nisi')
         ])),
  ...
  object([
    ...
    prop(key('isActive'), _false()), prop(key('balance'), string('$1,696.52')),
    prop(key('picture'), string('http://placehold.it/32x32')),
    prop(key('age'), number('32')), prop(key('eyeColor'), string('blue')),
    prop(
        key('name'), object([
          prop(key('first'), string('Ada')), prop(key('last'), string('Stokes'))
        ])),
    ...
    prop(key('tags'), array([
           string('qui'), string('eiusmod'), string('nisi'), string('officia'),
           string('in')
         ])),
    prop(key('range'), array([
           number('0'), number('1'), number('2'), number('3'), number('4'),
