...
const ast = array([
  object([
    ...
    prop(key("name"), object([prop(key("first"), string("Stacie")), prop(key("last"), string("Sargent"))])),
    ...
    prop(key("tags"), array([string("veniam"), string("et"), string("cillum"), string("ex"), string("nisi")])),
    prop(
      key("range"),
      array([
        number("0"),
    ...
    prop(
      key("friends"),
      array([
        object([prop(key("id"), number("0")), prop(key("name"), string("Juliana Valentine"))]),
        object([prop(key("id"), number("1")), prop(key("name"), string("Robert Eaton"))]),
        object([prop(key("id"), number("2")), prop(key("name"), string("Socorro Herrera"))]),
      ]),
    ),
  ...
  object([
    ...
    prop(key("name"), object([prop(key("first"), string("Ada")), prop(key("last"), string("Stokes"))])),
    ...
    prop(key("tags"), array([string("qui"), string("eiusmod"), string("nisi"), string("officia"), string("in")])),
    prop(
      key("range"),
      array([
        number("0"),
    ...
    prop(
      key("friends"),
      array([
        object([prop(key("id"), number("0")), prop(key("name"), string("Campos Pruitt"))]),
        object([prop(key("id"), number("1")), prop(key("name"), string("Barnett Sykes"))]),
        object([prop(key("id"), number("2")), prop(key("name"), string("Trudy Collier"))]),
      ]),
    ),
